...
{
    /// <summary>
    /// Response DTO for partner bookings list with pagination
    /// </summary>
    public class PartnerBookingsResponse
    {
        public int Page { get; set; }
        public int PageSize { get; set; }
        public int TotalItems { get; set; }
        public int TotalPages { get; set; }
        public List<PartnerBookingItemDto> Items { get; set; } = new List<PartnerBookingItemDto>();
    }

    /// <summary>
    /// Individual booking item in partner's list
    /// </summary>
    public class PartnerBookingItemDto
    {
    ...
    /// </summary>
    public class PartnerBookingCustomerDto
    {
    ...
    /// </summary>
    public class PartnerBookingShowtimeDto
    {
    ...
    /// </summary>
    public class PartnerBookingCinemaDto
    {
    ...
    /// </summary>
    public class PartnerBookingMovieDto
    {
